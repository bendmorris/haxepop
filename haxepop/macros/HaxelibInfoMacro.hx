...
class HaxelibInfoMacro
{
	...
	macro public static function build():Array<Field>
	{
		...
		try
		{
			var process = new Process("haxelib", ["path", "haxepop"]);
		...
		{
			if (StringTools.trim(lines[i]) == "-D haxepop" ||
				StringTools.startsWith(StringTools.trim(lines[i]), "-D haxepop="))
			{
